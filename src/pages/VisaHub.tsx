...
const PrimaryCard: React.FC<{ country: Country }> = ({ country }) => (
    <Link
        ...
        className="group relative p-6 rounded-2xl border border-t-border bg-t-card
            hover:border-t-strong/40 transition-all duration-500
            flex flex-col overflow-hidden min-h-[200px] sm:min-h-[240px]"
    >
        {/* Ghost watermark — clamp keeps it inside card on narrow screens */}
        <span
            aria-hidden="true"
            ...
            style={{
                ...
                fontSize: 'clamp(7rem, 35vw, 14rem)',
                lineHeight: 1,
...
const SecondaryCard: React.FC<{ country: Country }> = ({ country }) => (
    <Link
        to={`/visas/${country.slug}`}
        className="group relative flex items-center justify-between p-4 rounded-xl border border-t-border bg-t-card
            hover:border-t-strong/30 transition-all duration-300 overflow-hidden min-h-[56px]"
    >
        {/* Ghost watermark — smaller font, still clipped by overflow-hidden */}
        <span
            aria-hidden="true"
            className="absolute font-heading select-none pointer-events-none transition-all duration-700 group-hover:scale-110"
            style={{
        ...
        <div className="min-h-screen bg-transparent">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
                <div className="mb-12 md:mb-16">
                    ...
                    {/* No <br> on mobile — let text wrap naturally */}
                    ...
                    <p className="text-t-muted text-base md:text-lg max-w-2xl leading-relaxed">
